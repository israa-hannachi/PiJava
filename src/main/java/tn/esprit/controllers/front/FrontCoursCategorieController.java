...
public class FrontCoursCategorieController implements Initializable {
    ...
    @FXML public void handleMeets() { navigateTo("/tn/esprit/view/front_MeetList.fxml"); }
    @FXML public void handleCours() {
        // Refresh or do nothing since we are already in Cours
        handleSearch();
    }
