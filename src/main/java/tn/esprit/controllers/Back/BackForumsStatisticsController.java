...
public class BackForumsStatisticsController implements Initializable {
    ...
    @FXML
    public void handleTrends(ActionEvent event) {
        navigateTo("/tn/esprit/view/back_forums_trends.fxml", event);
    }

    @FXML
    public void handleSummaryReport(ActionEvent event) {
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Rapport résumé");
        alert.setHeaderText(null);
        alert.setContentText("Génération du rapport résumé...");
        alert.showAndWait();
    }

    @FXML
    public void handleRefresh(javafx.scene.input.MouseEvent event) {
        loadStatistics();
        setupCharts();
    }
