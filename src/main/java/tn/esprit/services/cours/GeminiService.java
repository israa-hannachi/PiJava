...
public class GeminiService {
    ...
    private void loadConfiguration() {
        try {
            ...
            if (configStream != null) {
                ...
                // Charger la clé API
                this.apiKey = config.getProperty("GEMINI_API_KEY", "");
                
                if (apiKey.isEmpty() || apiKey.equals("AIzaSyDYsaElVpItsnMrJ5RAhDg7J55TwCxmCSY")) {
            ...
            this.apiKey = "AIzaSyDYsaElVpItsnMrJ5RAhDg7J55TwCxmCSY";
        }
    }
    ...
    public void updateApiKey(String newApiKey) {
        if (newApiKey != null && !newApiKey.trim().isEmpty() && !newApiKey.equals("AIzaSyDYsaElVpItsnMrJ5RAhDg7J55TwCxmCSY")) {
    ...
    public boolean isApiKeyValid() {
        return apiKey != null && !apiKey.trim().isEmpty() && !apiKey.equals("AIzaSyDYsaElVpItsnMrJ5RAhDg7J55TwCxmCSY");
    }
