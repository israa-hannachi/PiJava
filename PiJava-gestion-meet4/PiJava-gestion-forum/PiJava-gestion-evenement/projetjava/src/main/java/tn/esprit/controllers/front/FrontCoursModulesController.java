...
public class FrontCoursModulesController implements Initializable {
    ...
    private void renderCards(List<Cours_Module> list) {
        ...
        for (Cours_Module mod : list) {
            ...
            card.setStyle("-fx-background-color:linear-gradient(to bottom right,#ffffff,#f7fffd); -fx-background-radius:22; -fx-padding:22; -fx-border-color:rgba(20,184,166,0.16); -fx-border-radius:22; -fx-cursor:hand; -fx-effect:dropshadow(gaussian,rgba(15,23,42,0.10),22,0,0,8);");
            ...
            card.setOnMouseEntered(e -> card.setStyle("-fx-background-color:linear-gradient(to bottom right,#ffffff,#ecfeff); -fx-background-radius:22; -fx-padding:22; -fx-border-color:#14b8a6; -fx-border-radius:22; -fx-cursor:hand; -fx-effect:dropshadow(gaussian,rgba(20,184,166,0.26),28,0,0,10);"));
            card.setOnMouseExited(e -> card.setStyle("-fx-background-color:linear-gradient(to bottom right,#ffffff,#f7fffd); -fx-background-radius:22; -fx-padding:22; -fx-border-color:rgba(20,184,166,0.16); -fx-border-radius:22; -fx-cursor:hand; -fx-effect:dropshadow(gaussian,rgba(15,23,42,0.10),22,0,0,8);"));
    ...
    public void handleBack() {
        try {
            ...
            javafx.stage.Stage stage = (javafx.stage.Stage) profileButton.getScene().getWindow();
