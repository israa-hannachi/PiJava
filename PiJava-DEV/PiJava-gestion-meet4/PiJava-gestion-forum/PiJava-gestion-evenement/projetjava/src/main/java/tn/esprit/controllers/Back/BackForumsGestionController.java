...
public class BackForumsGestionController implements Initializable {
    ...
    private void setupComboBoxes() {
        ...
        categorieCombo.setConverter(new javafx.util.StringConverter<Categorie>() {
            @Override
            ...
            public Categorie fromString(String string) {
                return categorieCombo.getItems().stream()
    ...
    private SortedList<Forum> sortedData;

    private void setupSearchListeners() {
        // Listener pour le tri par date (le bouton 🔍 et APPLIQUER gèrent la recherche textuelle)
    ...
    private void applyFilters() {
        ...
        filteredData.setPredicate(forum -> {
            boolean matchEtat = etatSearch.isEmpty()
                    || (forum.getEtat() != null && forum.getEtat().toLowerCase().startsWith(etatSearch));
    ...
    @FXML
    public void handleSaveForum(ActionEvent event) {
        errorLabel.setVisible(false);
        ...
        if (selectedForum == null) {
            ...
            selectedForum.setCreatedBy(createdBy.trim());
    ...
    @FXML public void handleBackToDashboard(ActionEvent event) { navigateSimple("/tn/esprit/view/back_forum_dashboard.fxml", event); }
    ...
    private void applyPagination() {
        ...
        if (fromIndex < totalItems) {
            ...
            forumsTable.setItems(FXCollections.observableArrayList());
        }
